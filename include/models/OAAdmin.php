 ...
 */
class OAAdmin extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('admin_type, del_flag', 'numerical', 'integerOnly'=>true),
			...
			array('id, name, password, last_login_time, admin_type, create_time, memo, del_flag', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return OAAdmin the static model class
	 */
