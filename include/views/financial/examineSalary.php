...
<div id="content-header">
    <div id="breadcrumb">
        ...
        <a href="/financial/examineSalary" class="current">工资审核</a>
    </div>
</div>
            ...
            <div class="widget-box">
                <div class="widget-title">
                    <ul class="nav nav-pills">
                        <li class="active"><a href="/financial/examineSalary/">一次工资</a></li>
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <?php }else {  foreach ($list as $k => $row){
                            ...
                            <tr>
                                ...
                                <td><div>一次工资</div></td>
                                <td><div><?php echo $row['sum_per_daikoushui'];?></div></td>
