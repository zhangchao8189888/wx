...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            ...
            按审批状态排序：
            <select id="sortByStatus"  date-type="er">
            ...
            <div class="widget-box">
                <div class="widget-title">
                    <ul class="nav nav-pills">
                        ...
                        <li class="active"><a href="/financial/examineErSalary">二次工资</a></li>
                        <li class=""><a href="/financial/examineNianSalary">年终奖</a></li>
                    </ul>
                ...
                <div class="widget-content nopadding">
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th class="tl"><div>工资月份(可查看)</div></th>
                        ...
                        <?php }else {  foreach ($list as $k => $row){
                            ...
                            <tr>
                                ...
                                <td><div><a title="查看" href="<?php echo $this->createUrl('checkSalaryList', array('id'=>$row['id'],'type'=>"second"));?>" style="cursor:pointer" target="_blank" class="rowCheck theme-color"><?php echo $row['salaryTime'];?></a></div></td>
                                <td><div><?php echo $row['sum_bukoushui'];?></div></td>
...
<div class="modal hide" id="modal-deal-event">
    ...
    <div class="modal-body">
        ...
        <a href="javascript:void();" class="btn btn-primary dealAct" data-val="2" data-type="er">同意</a>
        <a href="javascript:void();" class="btn btn-primary dealAct" data-val="3" data-type="er">拒绝</a>
    </div>
</div>
<!--处理审核--END---->

<script language="javascript" type="text/javascript" src="<?php echo FF_DOMAIN;?>/upload/common-js/zq.examineSalary.js?2" charset="utf-8"></script>
