...
<div class="container-fluid"><span class="btn btn-primary" id="export">导出</span>
            ...
            <div class="widget-box">
                <div class="tab-content">
                    <div class="tab-pane active" id="home">
                        <div class="controls">
                            <!-- checked="checked"-->
                            <input type="button" value="保存" class="btn btn-success" id="save" >
                        ...
                        <div id="exampleGrid" class="dataTable" style="width:1100px;height: 700px; overflow: hidden"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        var content = <?php echo json_encode($viewList,true);?>;
    </script>
    ...
    <script type="text/javascript" src="<?php echo FF_STATIC_BASE_URL;?>/common-js/salary/salaryView.js?5"></script>
</div>