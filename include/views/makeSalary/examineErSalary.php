...
<div class="widget-title">
    <ul class="nav nav-pills">
        ...
        <li class="active"><a href="<?php echo $this->createUrl('examineErSalary');?>">二次工资</a></li>
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <?php }else {  foreach ($list as $k => $row){
                            ...
                            <tr>
                                ...
                                <td><div><a href="javascript:void();" class="updateStatus <?php echo $row->salary_status==0 ? 'btn btn-primary' : '';?>" data-type="er" data-status="<?php echo $row->salary_status?>" data-id="<?php echo $row->id;?>"><?php echo FConfig::item('config.examine_status.'.$row->salary_status);?></a></div></td>
                            </tr>
                        <?php }}?>
                        </tbody>
                    </table>
