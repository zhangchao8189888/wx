...
<div id="content" style="margin-left:0px;">
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a href="/makeSalary/salaryFirstSearchPage">工资管理</a>
            <a href="#" class="current">工资查询  </a>
        </div>
    </div>
                ...
                <div class="widget-box">
                    <div class="controls">
                        <form>
                            ...
                            <div>公司名称：<label><?php echo $salTime['companyName'];?></label>工资月份：<label><?php echo $salTime['salaryTime'];?></label></div>
                        ...
                        <!--功能项-->
                        <div id="first" class="manage" style="word-wrap: break-word; background-color: Tan;display: block;">
                            <form enctype="multipart/form-data" id="iform" action="" method="post">
                                ...
                                免税项：<input type="text" id="freeTex" name="sDate" id="sDate" value="" />
                        ...
                        <div id="nian" class="manage"
                            ...
                            <form enctype="multipart/form-data" id="iform_nian" action="index.php?action=Salary&mode=sumSalary" method="post">
...
<div class="modal hide" id="modal-event1">
    ...
    <form action="" id="company_validate" method="post" class="form-horizontal"  novalidate="novalidate">
        <div class="modal-body">
            <div class="designer_win">
                <div class="tips"><em style="color: red;padding-right: 10px;">*</em>所属公司：<?php echo $salTime['companyName'];?><input type="hidden" value="<?php echo $salTime['companyId'];?>" id="company_id" name="company_id" /></div>
    ...
    <div class="search_suggest" id="custor_search_suggest" style="display: none;">
        <ul class="search_ul">
...
<script type="text/javascript" src="<?php echo FF_STATIC_BASE_URL;?>/common-js/zq.addSalaryPage.js"></script>