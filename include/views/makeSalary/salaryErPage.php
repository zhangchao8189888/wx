...
<script src="<?php echo FF_STATIC_BASE_URL;?>/common-js/salary/zq.salaryEr.js?3"></script>
                ...
                <form enctype="multipart/form-data" id="iform" action="" method="post">
                    <div class="manage">
                        <div class="controls">
                            ...
                            <!--<select id="salary_time_id">
                                <option value="-1">一次工资月份</option>
                            </select>-->
                        </div>
                        ...
                        <div id="first" class="manage"
                             style="word-wrap: break-word; background-color: yellow;display: block;">
                            ...
                            二次工资月份（2012-01-01）：<input type="text" name="salaryTime_er" id="salaryTime_er" onFocus="WdatePicker({isShowClear:false,readOnly:true,'dateFmt':'yyyy-MM'})"/>
                            <input type="button" value="二次工资计算" data-type="1" class="sumErSalary" /></font>
