...
<div class="container-fluid">
    <div class="container-fluid"><span class="btn btn-primary" id="export">导出</span>&nbsp&nbsp&nbsp<span class="btn btn-primary" id="exportFirst">一次工资单位导出</span>&nbsp&nbsp&nbsp<span class="btn btn-primary" id="exportEr">二次工资单位导出</span>
        <div class="search-form">
            <div class="row-fluid1">
                <div class="widget-box">
                    <div class="controls">
                        年度查询：<input type="text" id="sal_date" name="sal_date" value="<?php echo date("Y");?>"  onFocus="WdatePicker({isShowClear:false,readOnly:true,'dateFmt':'yyyy'})"/>
        ...
        <script type="text/javascript" src="<?php echo FF_STATIC_BASE_URL;?>/common-js/financial/zq.nianTaxList.js?11"></script>
