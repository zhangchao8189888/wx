        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="controls">
                    ...
                    导入时间：<input type="text" id="search_time" name="produce_date" value="<?php echo date("Y-m");?>"  onFocus="WdatePicker({isShowClear:false,readOnly:true,'dateFmt':'yyyy-MM'})"/>
                    <input type="checkbox" id="noTime">不选时间
                </div>
            </div>
            <div class="widget-box">
                <div class="controls">
                    <div style="float: right;margin-right: 5px"><span id="save_btn" class="btn btn-success btn_save"/>保存</span></div>
...
<script type="text/javascript" src="<?php echo FF_STATIC_BASE_URL;?>/common-js/zq.showsocialList.js"></script>
