<div id="content-header">
    <div id="breadcrumb">
        ...
        <a href="/product/productList" class="current">公积金减员列表</a>
    </div>
</div>
...
<script type="text/javascript" src="<?php echo FF_STATIC_BASE_URL;?>/common-js/zq.showgjjinReduceList.js"></script>
