<div id="content-header">
    <div id="breadcrumb">
        ...
        <a href="/social/" class="current">社保管理</a>
        <a href="/social/showSocialException" class="current">社保/公积金异常列表</a>
    </div>
</div>
        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="controls">
                    ...
                    更新时间：<input type="text" id="search_time" name="produce_date" value="<?php echo date("Y-m-d");?>"  onFocus="WdatePicker({isShowClear:false,readOnly:true,'dateFmt':'yyyy-MM-dd'})"/>
<!--                    <input type="checkbox" id="noTime">不选时间-->
                    <div style="float: right;margin-right: 5px"><span id="search_btn" class="btn btn-success"/>查询</span></div>
                </div>
            </div>
            <div class="widget-box">
                <div class="controls">
                    <div style="float: right;margin-right: 5px"><span id="add_btn" class="btn btn-primary"/>保存</span></div>
                </div>
            </div>
            <div class="widget-box">
                <div class="controls">
...
<script type="text/javascript" src="<?php echo FF_STATIC_BASE_URL;?>/common-js/zq.showSocialException.js"></script>
